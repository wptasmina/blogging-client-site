...
export default function Navbar() {
    ...
    <div className="dropdown">
      ...
      <ul
        ...
        className="menu menu-sm dropdown-content bg-gray-800 rounded-box z-[1] mt-2 w-60 p-2 py-10 gap-4  shadow">
          <li className='text-white bg-gray-800 md:ml-0 text-xl font-bold'>
  ...
  <div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal px-1 gap-4">
      <li className='text-white bg-gray-800 text-md font-medium rounded-md'><NavLink to="/">Home</NavLink></li>
      <li className='text-white bg-gray-800 text-md font-medium rounded-md'><NavLink to="/addblog">Add blogs</NavLink></li>
      <li className='text-white bg-gray-800 text-md font-medium rounded-md'><NavLink to="/wishlist">Wishlist</NavLink></li>
      <li className='text-white bg-gray-800 text-md font-medium rounded-md'><NavLink to="/allblogs">All Blogs</NavLink></li>
